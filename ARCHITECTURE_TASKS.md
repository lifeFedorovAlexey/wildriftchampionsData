...
- [ ] Шаг 2. Удалить legacy `skins` ingestion path, завязанный на `ui/public/merged`, и убрать связанный API/domain-рудимент только после проверки, что клиентская страница и маршрут больше не используются.
